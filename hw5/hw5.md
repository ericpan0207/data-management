...
**Questions:** Post them on the [discussion board](https://piazza.com/class/jf8j1sdnwa175p?cid=207). Tag your post with "Asterix" on Piazza if it pertains to the syntax of SQL++ / AsterixDB installation problems. Otherwise tag your questions with "HW5."
...
- [starter code](https://gitlab.cs.washington.edu/cse344-18sp/cse344-18sp/tree/master/hw5/starter-code): which contains `monidal.adm` (the entire dataset), `country`, `mountain`, and `sea` (three subsets)
